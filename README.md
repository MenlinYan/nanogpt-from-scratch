...
本机已检测到 NVIDIA RTX 3070 Laptop（8 GB）。建议使用 Python 3.11 或 3.12 新建环境，
然后按 [docs/setup.md](docs/setup.md) 安装与验证。8 GB 显存足以完成字符级小模型、GPT-2
small 级别的受限实验和优化对比，但不以复现 GPT-2 预训练成本为目标。
